  ...
  return (
    submited === false ? (
      ...
      <div className="max-w-103 bg-gradient-dark p-6 rounded-2xl text-white font-overpass text-center">
        ...
        <p className="text-sm text-light-grey mb-6">Agradecemos por você reservar um tempo para dar uma classificação. Se precisar de mais suporte, não hesite em entrar em contato!</p>
      </div>
    )
  )
}